...
RESULTS_DIR = "results/efficientnet/check"
...
RUN_CONFIG = {
    ...
    "COMMENT":"""Lr increasing very little and tried reducing dropout as well 
        
     ###   Why graphs looks noisy

    Even with ROC-optimized threshold:
    Each epoch changes probability distribution slightly
    Small dataset (≈260 images)
    Fold validation size ≈50 images
    1–2 sample flips = 2–4% accuracy jump
