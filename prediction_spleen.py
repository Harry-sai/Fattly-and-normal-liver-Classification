...
# Prediction settings
# -------------------------
MODEL_PATH = "spleen/7th_run_semisupervised_tuned/best_unet_fold_3.pth"
IMAGE_DIR  = "data/images"
OUT_DIR    = "data/spleen_masks_alternate"
...
with torch.no_grad():
    for img_path in Path(IMAGE_DIR).rglob("*"):
        ...
        mask = np.array(
            Image.fromarray(mask).resize((orig_w, orig_h), resample=Image.NEAREST)
        )
