...
RESULTS_DIR      = "spleen/3rd_run_peseudo"
...
RUN_CONFIG = {
    ...
    "COMMENT":"""spleen segmentation run with lower lr, threshold 0.5, stronger overlap loss, dice-based checkpointing, and validation previews
            """
}
